...
extern CURSOR *cursor;	//光标记

MENU_PAGE DATA_EDIT, CAN_IO;
__M_PAGE(DATA_EDIT,"DataEdit",&UI_MENU,
{
	SOLGUI_Cursor(6, 0, 9);
//	SOLGUI_Widget_Spin(0, "SpeedKp =", FLT16, -1000, 1000, &speed.kp);
//	SOLGUI_Widget_Spin(1, "SpeedKi =", FLT16, -1000, 1000, &speed.ki);
//	SOLGUI_Widget_Spin(2, "SetSpeed=", FLT16, -1000, 1000, &SetSpeed);
//	SOLGUI_Widget_Spin(3, "CurrentKp=", FLT16, -1000, 1000, &current.kp);
//	SOLGUI_Widget_Spin(4, "CurrentKi=", FLT16, -1000, 1000, &current.ki);
//	SOLGUI_Widget_Spin(5, "SetCurrent=", FLT16, -1000, 1000, &SetCurrent);
//	SOLGUI_Widget_Spin(6, "Encorder:", FLT16, 0, 1000, &EncoderPulse);
//	SOLGUI_Widget_Spin(7, "pidout=", FLT16, -1000, 1000, &speed.pidout);
//	SOLGUI_Widget_Button(8, "FlashSave", FlashSaveData);
	//SOLGUI_Widget_GotoPage(7,&UI_MENU);

});

__M_PAGE(CAN_IO, "CAN IO", &UI_MENU,
		 {
			 SOLGUI_Cursor(6, 0, 2);
//			 SOLGUI_Widget_Button(1, "SendViaCAN", SendviaCan);
			 //	SOLGUI_Widget_OptionText(0, "S145 : %d",S145);
			 //	SOLGUI_Widget_OptionText(1, "S546 : %d",S546);
			 //	SOLGUI_Widget_OptionText(2, "S844 : %d",S844);
			 //	SOLGUI_Widget_OptionText(3, "S132 : %d",S132);
			 //	SOLGUI_Widget_OptionText(4, "S144 : %d",S144);
			 //
		 });
